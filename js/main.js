/* ============================================
   GRAVESØRVIS SKEDSMO - Main JavaScript
   ============================================ */
...
function initContactForm() {
    ...
    form.addEventListener('submit', async function(e) {
        ...
        const formData = {
            ...
            desiredStart: form.querySelector('#desiredStart')?.value || '',
        ...
        try {
            ...
            alert('Det oppstod en feil ved sending. Vennligst prøv igjen eller ring oss direkte.');
        } finally {
            submitBtn.disabled = false;
            submitBtn.innerHTML = '<span>Send Forespørsel</span>';
        }
    });
...
function initAnimations() {
    ...
    const animatedElements = document.querySelectorAll(
        ...
        '.service-area-card, .area-card, .project-type-card, .equipment-item'
    );
